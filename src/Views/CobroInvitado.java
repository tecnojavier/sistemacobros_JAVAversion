 ...
 * @author TECNOJAVIER
 */
public class CobroInvitado extends javax.swing.JFrame {

    public CobroInvitado() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CobroInvitado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CobroInvitado().setVisible(true);
            }
        });
    }
