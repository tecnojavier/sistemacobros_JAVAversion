...
public class RegistroAdmin extends javax.swing.JFrame {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("DELETE FROM cliente WHERE Dui = ?");
            ...
            if (res > 0) {
                ...
                JOptionPane.showMessageDialog(null, "No se encontró ningún registro con el DUI especificado");
            }
