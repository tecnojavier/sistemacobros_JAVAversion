...
public class Login2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 590, 40));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        if (!txtCorreo.getText().isEmpty() && !txtContrasena.getText().isEmpty()) {
            MetodosSql_1 con = new MetodosSql_1();
            con.accesoUsuario(txtCorreo.getText(), txtContrasena.getText());
            JOptionPane.showMessageDialog(this, "Bienvenido(a) \n" + "Iniciaste sesion como: \n" + "Administrador");
            Ingresos mostrar = new Ingresos();
